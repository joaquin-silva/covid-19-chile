...
def my_plot_2(df, col):
    ...
    fig.update_layout(
        title=f"{col} por país", xaxis_title=col, template="ggplot2", height=750
    )
...
def main():
    ...
    st.markdown(
        "Datos provistos por [Our World in Data](https://github.com/owid/covid-19-data/tree/master/public/data)."
    )
    ...
    pais_select = st.multiselect(
        "Seleccionar países", paises, ["Chile", "Argentina", "Peru"]
    )
